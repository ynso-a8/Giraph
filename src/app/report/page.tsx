...
export default function ReportPage() {
  ...
  // Past capsule logic: Find a past log (e.g. nearest to 3 days ago, or any past log older than 2 days)
  const pastCapsule = useMemo(() => {
    ...
    // Pick the one closest to 3 days ago or simply the most recent of the past logs
    return pastLogs[0];
  }, [logs]);
  ...
  return (
    <div className="flex flex-col gap-6 w-full animate-fade-in">
      ...
      <div className="flex flex-col gap-1 border-b border-white/5 pb-4">
        ...
        <h1 className="text-lg font-black text-white tracking-tight">과거와 미래의 연결</h1>
        <p className="text-[10px] text-zinc-500 font-semibold mt-0.5">과거의 마음 조각을 되돌아보고, 미래의 나에게 굳건한 위로를 전송하세요.</p>
      </div>
            ...
            <form onSubmit={handleSaveFutureLetter} className="p-5.5 rounded-3xl border border-white/5 bg-zinc-900/10 backdrop-blur-sm flex flex-col gap-4">
              <div className="flex flex-col gap-1.5">
                ...
                <textarea
                  ...
                  placeholder="예: 지금 힘들더라도 기래프가 꿋꿋하게 자라나듯 너도 매일 성장하고 있을 거야! 1주일 뒤엔 원하는 과제도 끝나서 웃고 있겠지? 기죽지 말고 힘내자!"
                  rows={3}
                  required
